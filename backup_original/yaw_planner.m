...
% %YAW_PLANNER Yaw referanslarını hesaplar (Low-Speed korumalı).
% 
%     switch lower(mode)
%         case "constant"
...
%             v_sq = vx^2 + vy^2;
% 
%             % Hız eşiği: 0.5 m/s'den yavaşsa yön değiştirmeye çalışma
%             if v_sq < 0.25 
%                 % Eğer params içinde önceki değer varsa onu koru
...
%                 % Önceki açıdan çok farklıysa (örn: 359 -> 1), en kısa yolu seç
%                 if isfield(params, 'last_psi')
